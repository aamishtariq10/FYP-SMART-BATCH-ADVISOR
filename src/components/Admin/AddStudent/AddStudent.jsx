            ...
            <section className="flex w-full h-full justify-center items-center">
                ...
                {/* <div className="flex justify-center items-center h-screen w-full bg-blue-400"> */}
                    <div className="w-full bg-white rounded shadow-2xl p-8 m-4">
                        <h1 className="block w-full text-center text-gray-800 text-2xl font-bold mb-6">Register New Student</h1>
                ...
                <select name="section" id="section">
                  ...
                  <option value="F">F</option>
                            ...
                            <div className="flex flex-col mb-4">
                                <label className="mb-2 font-bold text-lg text-gray-900" htmlFor="cgpa">CGPA</label>
                                <input className="border py-2 px-3 text-grey-800" type="test" name="cgpa" id="cgpa"/>
                            </div>
